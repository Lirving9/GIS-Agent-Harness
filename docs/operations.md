...
- `pytest -q tests/test_blueprint_execution.py` exercises executable MCP dispatch, DAG ordering, repeated-failure compaction, provenance narrative generation, runnable benchmark checks, and the requirement matrix
